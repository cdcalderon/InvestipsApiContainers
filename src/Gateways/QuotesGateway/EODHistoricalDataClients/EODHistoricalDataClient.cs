...
namespace EODHistoricalData.NET
{
    public class EODHistoricalDataClient : AuthentifiedClient
    {
        ...
        public List<HistoricalPrice> GetHistoricalHourlyPrices(string symbol, DateTime startDate, DateTime endDate)
        {
            if (symbol == null)
                throw new ArgumentNullException("Symbol is null, cannot query prices.");
            ...
            return _stockPriceDataClient.GetHistoricalHourlyPrices(symbol, startDate, endDate);
        }
